                    ...
                    <div class="">
                        <div class="mb-4">
                            ...
                            <input type="text"
                                ...
                                id="exampleFormControlInput1" placeholder="Ingresar estado civil" wire:model="NombreEstadoCivil">
                            @error('NombreEstadoCivil') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
                    </div>
                </div>
