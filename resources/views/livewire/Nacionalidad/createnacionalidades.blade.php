                    ...
                    <div class="">
                        <div class="mb-4">
                            ...
                            <input type="text"
                                ...
                                id="exampleFormControlInput1" placeholder="Ingresar nacionalidad" wire:model="NombreNacionalidad">
                            @error('nombreNacionalidad') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
                    </div>
                </div>
